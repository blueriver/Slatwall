<cfcomponent extends="Slatwall.com.utility.BaseObject" output="false">
	...
	<cffunction name="syncPush" access="public" returntype="Any" >
		...
		<cftry>
			<cfftp action="putfile" server="#integration.setting('syncFTPSite')#" username="#integration.setting('syncFTPSiteUsername')#" password="#integration.setting('syncFTPSitePassword')#" port="#integration.setting('syncFTPSitePort')#"
				   remotefile="#remoteFullFilePath#" localfile="#localFullFilePath#">
			<cfcatch>
