	...
	<cffunction name="productImport" returntype="void">
		...
		<cfloop file="#importDirectory##newFilename#" index="fileLine">
			...
			<cfif arrayLen(lineArray) gt 1
				...
				and (listLen(lineArray[2], ":") eq 4 OR ( listLen(lineArray[2], ":") eq 3 and listGetAt(lineArray[2], 2, ":") neq "ALL OVER PRINTS" and listGetAt(lineArray[2], 2, ":") neq "MEN'S PREMIUM T'S" and listGetAt(lineArray[2], 2, ":") neq "MEGA PACK SPECIAL" and listGetAt(lineArray[2], 2, ":") neq "WOMEN'S ALL OVER T'S" and listGetAt(lineArray[2], 2, ":") neq "WOMEN'S PREMIUM T'S"))
