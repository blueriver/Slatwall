...
*/
component displayname="Order" entityname="SlatwallOrder" table="SlatwallOrder" persistent=true output=false accessors=true extends="BaseEntity" hb_serviceName="orderService" hb_permission="this" {
