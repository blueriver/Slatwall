...
*/
component displayname="Account Phone Number" entityname="SlatwallAccountPhoneNumber" table="SlatwallAccountPhoneNumber" persistent="true" accessors="true" output="false" extends="HibachiEntity" hb_serviceName="accountService" hb_permission="account.accountPhoneNumbers" {
