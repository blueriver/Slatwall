...
*/
component displayname="Schedule" entityname="SlatwallSchedule" table="SlatwallSchedule" persistent="true" accessors="true" extends="BaseEntity" hb_serviceName="scheduleService" hb_permission="this" {
