...
*/
component displayname="Vendor VendorOrder" entityname="SlatwallVendorOrder" table="SlatwallVendorOrder" persistent="true" accessors="true" output="false" extends="HibachiEntity" hb_serviceName="vendorOrderService" hb_permission="this" {
