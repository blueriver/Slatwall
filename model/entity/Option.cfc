...
component displayname="Option" entityname="SlatwallOption" table="SwOption" persistent=true output=false accessors=true extends="HibachiEntity" cacheuse="transactional" hb_serviceName="optionService" hb_permission="optionGroup.options" {
	...
	property name="promotionQualifierExclusions" singularname="promotionQualifierExclusion" cfc="PromotionQualifier" type="array" fieldtype="many-to-many" linktable="SwPromotionQualifierExclOption" fkcolumn="optionID" inversejoincolumn="promotionQualifierID" inverse="true";
