...
*/
component displayname="Measurement Unit" entityname="SlatwallMeasurementUnit" table="SlatwallMeasurementUnit" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="measurementService" hb_permission="this" {
