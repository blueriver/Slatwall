...
*/
component displayname="Stock Hold" entityname="SlatwallStockHold" table="SlatwallStockHold" persistent=true accessors=true output=false extends="BaseEntity" hb_serviceName="stockService" {
