...
*/
component entityname="SlatwallState" table="SlatwallState" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="addressService" hb_permission="this" {
