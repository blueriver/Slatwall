...
*/
component displayname="Vendor Email Address" entityname="SlatwallVendorEmailAddress" table="SlatwallVendorEmailAddress" persistent="true" extends="BaseEntity" hb_serviceName="vendorService" hb_permission="vendor.vendorEmailAddresses" {
