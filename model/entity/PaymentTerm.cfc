...
*/
component displayname="Payment Term" entityname="SlatwallPaymentTerm" table="SlatwallPaymentTerm" persistent="true" accessors="true" extends="BaseEntity" hb_serviceName="paymentService" hb_permission="this" {
