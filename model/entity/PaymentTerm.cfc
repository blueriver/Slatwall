...
*/
component displayname="Payment Term" entityname="SlatwallPaymentTerm" table="SlatwallPaymentTerm" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="paymentService" hb_permission="this" {
