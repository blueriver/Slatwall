...
*/
component displayname="Account Payment Method" entityname="SlatwallAccountPaymentMethod" table="SlatwallAccountPaymentMethod" persistent="true" accessors="true" extends="BaseEntity" hb_permission="account.accountPaymentMethods" {
