...
*/
component displayname="EmailTemplate" entityname="SlatwallEmailTemplate" table="SlatwallEmailTemplate" persistent="true" accessors="true" extends="BaseEntity" hb_serviceName="emailService" hb_permission="this" {
