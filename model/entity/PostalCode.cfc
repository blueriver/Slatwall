...
*/
component displayname="Postal Code" entityname="SlatwallPostalCode" table="SlatwallPostalCode" persistent="true" extends="BaseEntity" hb_serviceName="addressService" {
