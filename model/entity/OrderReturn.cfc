...
*/
component displayname="Order Return" entityname="SlatwallOrderReturn" table="SlatwallOrderReturn" persistent=true accessors=true output=false extends="HibachiEntity" hb_serviceName="orderService" hb_permission="order.orderReturns" {
