...
*/
component entityname="SlatwallSite" table="SlatwallSite" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="siteService" hb_permission="this" {
