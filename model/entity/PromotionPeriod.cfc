...
*/
component displayname="Promotion Period" entityname="SlatwallPromotionPeriod" table="SlatwallPromotionPeriod" persistent="true" extends="HibachiEntity" hb_serviceName="promotionPeriod" hb_permission="promotion.promotionPeriods" {
