...
component displayname="Product Type" entityname="SlatwallProductType" table="SwProductType" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="productService" hb_permission="this" hb_parentPropertyName="parentProductType" {
	...
	property name="loyaltyProgramAccruementExclusions" singularname="loyaltyProgramAccruementExclusion" cfc="LoyaltyProgramAccruement" type="array" fieldtype="many-to-many" linktable="SwLoyaltyProgramAccruementExcludedProductType" fkcolumn="productTypeID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
