...
component displayname="Product Type" entityname="SlatwallProductType" table="SlatwallProductType" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="productService" hb_permission="this" hb_parentPropertyName="parentProductType" {
	...
	property name="loyaltyProgramAccruements" singularname="loyaltyProgramAccruement" cfc="LoyaltyProgramAccruement" fieldtype="many-to-many" linktable="SlatwallLoyaltyProgramAccruementProductType" fkcolumn="productTypeID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
	property name="loyaltyProgramAccruementExclusions" singularname="loyaltyProgramAccruementExclusion" cfc="LoyaltyProgramAccruement" type="array" fieldtype="many-to-many" linktable="SlatwallLoyaltyProgramAccruementExcludedProductType" fkcolumn="productTypeID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
