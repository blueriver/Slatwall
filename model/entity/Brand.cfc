...
component displayname="Brand" entityname="SlatwallBrand" table="SwBrand" persistent=true output=false accessors=true extends="HibachiEntity" cacheuse="transactional" hb_serviceName="brandService" hb_permission="this" {
	...
	property name="loyaltyProgramAccruements" hb_populateEnabled="false" singularname="loyaltyProgramAccruement" cfc="LoyaltyProgramAccruement" fieldtype="many-to-many" linktable="SwLoyaltyProgramAccruementBrand" fkcolumn="brandID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
	property name="loyaltyProgramAccruementExclusions" hb_populateEnabled="false" singularname="loyaltyProgramAccruementExclusion" cfc="LoyaltyProgramAccruement" type="array" fieldtype="many-to-many" linktable="SwLoyaltyProgramAccruementExcludedBrand" fkcolumn="brandID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
