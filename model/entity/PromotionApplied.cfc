...
*/
component displayname="Promotion Applied" entityname="SlatwallPromotionApplied" table="SlatwallPromotionApplied" persistent="true" extends="HibachiEntity" hb_serviceName="promotionService" {
