...
*/
component displayname="Promotion Applied" entityname="SlatwallPromotionApplied" table="SlatwallPromotionApplied" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" {
