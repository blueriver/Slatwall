...
*/
component displayname="Access" entityname="SlatwallAccess" table="SlatwallAccess" persistent="true" accessors="true" extends="BaseEntity" hb_serviceName="accessService" {
