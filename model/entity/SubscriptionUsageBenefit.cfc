...
*/
component entityname="SlatwallSubscriptionUsageBenefit" table="SwSubscriptionUsageBenefit" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="subscriptionService" {
