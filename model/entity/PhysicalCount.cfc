...
*/
component entityname="SlatwallPhysicalCount" table="SlatwallPhysicalCount" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="physicalService" hb_permission="this" {
