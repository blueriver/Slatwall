...
*/
component entityname="SlatwallPhysicalCountItem" table="SlatwallPhysicalCountItem" persistent="true" accessors="true" extends="HibachiEntity"  hb_serviceName="physicalService" hb_permission="this" {
