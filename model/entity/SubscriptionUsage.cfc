...
*/
component entityname="SlatwallSubscriptionUsage" table="SwSubscriptionUsage" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="subscriptionService" {
