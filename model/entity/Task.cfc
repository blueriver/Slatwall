...
*/
component displayname="Task" entityname="SlatwallTask" table="SlatwallTask" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="scheduleService" hb_permission="this" {
