...
*/
component displayname="Comment" entityname="SlatwallComment" table="SlatwallComment" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="commentService" {
