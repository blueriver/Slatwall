...
*/
component displayname="Fulfillment Method" entityname="SlatwallFulfillmentMethod" table="SlatwallFulfillmentMethod" persistent=true output=false accessors=true extends="HibachiEntity" hb_serviceName="fulfillmentService" hb_permission="this" {
