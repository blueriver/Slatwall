...
*/
component displayname="Task History" entityname="SlatwallTaskHistory" table="SlatwallTaskHistory" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="scheduleService" {
