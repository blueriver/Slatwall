...
*/
component displayname="Payment Transaction" entityname="SlatwallPaymentTransaction" table="SlatwallPaymentTransaction" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="paymentService" {
