...
*/
component displayname="Comment Relationship" entityname="SlatwallCommentRelationship" table="SlatwallCommentRelationship" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="read-only" hb_serviceName="commentService" {
