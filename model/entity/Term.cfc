...
component entityname="SlatwallTerm" table="SwTerm" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="settingService" hb_permission="this" {
	...
	property name="loyaltyRedemptionBalanceTerms" singularname="loyaltyAccruementBalanceTerm" cfc="LoyaltyRedemption" type="array" fieldtype="one-to-many" fkcolumn="balanceTermID" cascade="all" inverse="true" lazy="extra";							// Extra Lazy because it is only used for validation
	property name="loyaltyAccruementAutoRedemptionTerms" singularname="loyaltyAccruementAutoRedemptionTerm" cfc="LoyaltyRedemption" type="array" fieldtype="one-to-many" fkcolumn="autoRedemptionTermID" cascade="all" inverse="true" lazy="extra";	// Extra Lazy because it is only used for validation
