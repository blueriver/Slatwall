...
component entityname="SlatwallTerm" table="SwTerm" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="settingService" hb_permission="this" {
	...
	property name="loyaltyProgramAccruementExpirationTerms" singularname="loyaltyProgramAccruementExpirationTerm" cfc="LoyaltyProgramAccruement" type="array" fieldtype="one-to-many" fkcolumn="expirationTermID" cascade="all" inverse="true" lazy="extra";				// Extra Lazy because it is only used for validation
	property name="loyaltyProgramRedemptionBalanceTerms" singularname="loyaltyProgramAccruementBalanceTerm" cfc="LoyaltyProgramRedemption" type="array" fieldtype="one-to-many" fkcolumn="balanceTermID" cascade="all" inverse="true" lazy="extra";							// Extra Lazy because it is only used for validation
	property name="loyaltyProgramAccruementAutoRedemptionTerms" singularname="loyaltyProgramAccruementAutoRedemptionTerm" cfc="LoyaltyProgramRedemption" type="array" fieldtype="one-to-many" fkcolumn="autoRedemptionTermID" cascade="all" inverse="true" lazy="extra";	// Extra Lazy because it is only used for validation
