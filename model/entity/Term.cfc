...
*/
component displayname="Term" entityname="SlatwallTerm" table="SlatwallTerm" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="settingService" hb_permission="this" {
