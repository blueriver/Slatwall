...
*/
component displayname="Subscription Term" entityname="SlatwallSubscriptionTerm" table="SlatwallSubscriptionTerm" persistent="true" accessors="true" extends="BaseEntity" hb_permission="this" {
