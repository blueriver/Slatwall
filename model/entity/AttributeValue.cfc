...
Notes:
	...
	account
*/
component displayname="Attribute Value" entityname="SlatwallAttributeValue" table="SlatwallAttributeValue" persistent="true" output="false" accessors="true" extends="HibachiEntity" hb_serviceName="attributeService" {
	...
	property name="attributeValueType" ormType="string" hb_formFieldType="select" formatType="custom" notnull="true";
