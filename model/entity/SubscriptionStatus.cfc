...
*/
component displayname="Subscription Status" entityname="SlatwallSubscriptionStatus" table="SlatwallSubscriptionStatus" persistent="true" accessors="true" extends="BaseEntity" hb_serviceName="subscriptionService" {
