...
*/
component displayname="Account Email Address" entityname="SlatwallAccountEmailAddress" table="SlatwallAccountEmailAddress" persistent="true" accessors="true" output="false" extends="HibachiEntity" hb_serviceName="accountService" hb_permission="account.accountEmailAddresses" {
