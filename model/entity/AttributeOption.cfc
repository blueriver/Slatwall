...
*/
component displayname="Attribute Option" entityname="SlatwallAttributeOption" table="SlatwallAttributeOption" persistent="true" accessors="true" output="false" extends="BaseEntity" hb_serviceName="attributeService" hb_property="attribute.attributeOptions" {
