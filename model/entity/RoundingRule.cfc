...
*/
component displayname="Rounding Rule" entityname="SlatwallRoundingRule" table="SlatwallRoundingRule" persistent=true output=false accessors=true extends="HibachiEntity" hb_serviceName="roundingRuleService" hb_permission="this" {
