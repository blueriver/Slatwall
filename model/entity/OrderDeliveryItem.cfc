...
*/
component displayname="Order Delivery Item" entityname="SlatwallOrderDeliveryItem" table="SlatwallOrderDeliveryItem" persistent="true" accessors="true" output="false" extends="BaseEntity" hb_serviceName="orderService" hb_permission="orderDelivery.orderDeliveryItems" {
