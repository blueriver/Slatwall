...
*/
component displayname="Price Group Rate" entityname="SlatwallPriceGroupRate" table="SlatwallPriceGroupRate" persistent=true output=false accessors=true extends="HibachiEntity" hb_serviceName="priceGroupService" hb_permission="priceGroup.priceGroupRates" {
