...
*/
component displayname="Stock Receiver Item" entityname="SlatwallStockReceiverItem" table="SlatwallStockReceiverItem" persistent=true accessors=true output=false extends="BaseEntity" hb_serviceName="stockService" {
