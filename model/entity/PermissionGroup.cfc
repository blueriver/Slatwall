...
*/
component displayname="PermissionGroup" entityname="SlatwallPermissionGroup" table="SlatwallPermissionGroup" persistent="true" extends="BaseEntity" hb_serviceName="accountService" hb_permission="this" {
