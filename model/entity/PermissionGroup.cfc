...
*/
component displayname="PermissionGroup" entityname="SlatwallPermissionGroup" table="SlatwallPermissionGroup" persistent="true" extends="HibachiEntity" hb_serviceName="accountService" hb_permission="this" {
