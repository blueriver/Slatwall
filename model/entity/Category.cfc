...
*/
component displayname="Category" entityname="SlatwallCategory" table="SlatwallCategory" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="contentService" hb_permission="this" hb_parentPropertyName="parentCategory" {
