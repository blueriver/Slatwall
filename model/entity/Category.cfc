...
*/
component displayname="Category" entityname="SlatwallCategory" table="SlatwallCategory" persistent="true" accessors="true" extends="BaseEntity" parentPropertyName="parentCategory" hb_permission="this" {
