...
*/
component displayname="Country" entityname="SlatwallCountry" table="SlatwallCountry" persistent="true" extends="HibachiEntity" hb_serviceName="addressService" hb_permission="this" {
