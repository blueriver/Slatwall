...
*/
component displayname="Country" entityname="SlatwallCountry" table="SlatwallCountry" persistent="true" extends="BaseEntity" hb_serviceName="addressService" hb_permission="this" {
