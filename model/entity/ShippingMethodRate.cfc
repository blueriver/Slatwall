...
*/
component displayname="Shipping Method Rate" entityname="SlatwallShippingMethodRate" table="SlatwallShippingMethodRate" persistent=true output=false accessors=true extends="HibachiEntity" hb_serviceName="shippingService" hb_permission="shippingMethod.shippingMethodRates" {
