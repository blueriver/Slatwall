...
*/
component displayname="Order Origin" entityname="SlatwallOrderOrigin" table="SlatwallOrderOrigin" persistent="true" accessors="true" extends="BaseEntity" hb_serviceName="settingService" hb_permission="this" {
