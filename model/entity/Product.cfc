...
component displayname="Product" entityname="SlatwallProduct" table="SwProduct" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="productService" hb_permission="this" hb_processContexts="updateSkus,addOptionGroup,addOption,addSubscriptionTerm" {
	...
	property name="loyaltyProgramAccruementExclusions" singularname="loyaltyProgramAccruementExclusion" cfc="LoyaltyProgramAccruement" type="array" fieldtype="many-to-many" linktable="SwLoyaltyProgramAccruementExcludedProduct" fkcolumn="productID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
