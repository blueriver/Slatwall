...
component displayname="Product" entityname="SlatwallProduct" table="SlatwallProduct" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="productService" hb_permission="this" hb_processContexts="updateSkus,addOptionGroup,addOption,addSubscriptionTerm" {
	...
	property name="loyaltyProgramAccruements" singularname="loyaltyProgramAccruement" cfc="LoyaltyProgramAccruement" fieldtype="many-to-many" linktable="SlatwallLoyaltyProgramAccruementProduct" fkcolumn="productID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
	property name="loyaltyProgramAccruementExclusions" singularname="loyaltyProgramAccruementExclusion" cfc="LoyaltyProgramAccruement" type="array" fieldtype="many-to-many" linktable="SlatwallLoyaltyProgramAccruementExcludedProduct" fkcolumn="productID" inversejoincolumn="loyaltyProgramAccruementID" inverse="true";
