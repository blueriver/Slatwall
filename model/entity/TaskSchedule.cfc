...
*/
component displayname="Task Schedule" entityname="SlatwallTaskSchedule" table="SlatwallTaskSchedule" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="scheduleService" hb_permission="task.taskSchedules" {
