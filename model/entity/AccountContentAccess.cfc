...
*/
component displayname="Account Content Access" entityname="SlatwallAccountContentAccess" table="SlatwallAccountContentAccess" persistent="true" accessors="true" extends="BaseEntity" hb_serviceName="accountService" {
