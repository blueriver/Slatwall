...
<cfsavecontent variable="local.productSub">
	<cfoutput>
		<cfif local.permissionService.secureDisplay('admin:entity.listproduct')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listproduct">#request.slatwallScope.rbKey('entity.product_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listproducttype')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listproducttype">#request.slatwallScope.rbKey('entity.producttype_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listoptiongroup')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listoptiongroup">#request.slatwallScope.rbKey('entity.optiongroup_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listbrand')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listbrand">#request.slatwallScope.rbKey('entity.brand_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listsubscriptionterm')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listsubscriptionterm">#request.slatwallScope.rbKey('entity.subscriptionterm_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listsubscriptionbenefit')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listsubscriptionbenefit">#request.slatwallScope.rbKey('entity.subscriptionbenefit_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listproductreview')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listproductreview">#request.slatwallScope.rbKey('entity.productreview_plural')#</a></li>	
		</cfif> 
		<cfif local.permissionService.secureDisplay('admin:entity.listpromotion')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listpromotion">#request.slatwallScope.rbKey('entity.promotion_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listpricegroup')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listpricegroup">#request.slatwallScope.rbKey('entity.pricegroup_plural')#</a></li>
		</cfif>
	</cfoutput>
</cfsavecontent>
<cfsavecontent variable="local.orderSub">
	<cfoutput>
		<cfif local.permissionService.secureDisplay('admin:entity.listorder')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listorder">#request.slatwallScope.rbKey('entity.order_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listorderfulfillment')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listorderfulfillment">#request.slatwallScope.rbKey('entity.orderfulfillment_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listvendororder')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listvendororder">#request.slatwallScope.rbKey('entity.vendororder_plural')#</a></li>
		</cfif>
	</cfoutput>
</cfsavecontent>
<cfsavecontent variable="local.accountSub">
	<cfoutput>
		<cfif local.permissionService.secureDisplay('admin:entity.listaccount')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listaccount">#request.slatwallScope.rbKey('entity.account_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listvendor')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listvendor">#request.slatwallScope.rbKey('entity.vendor_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listsubscriptionusage')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listsubscriptionusage">#request.slatwallScope.rbKey('entity.subscriptionusage_plural')#</a></li>
		</cfif>
		<cfif local.permissionService.secureDisplay('admin:entity.listpermissiongroup')>
			<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.listpermissiongroup">#request.slatwallScope.rbKey('entity.permissiongroup_plural')#</a></li>
		</cfif>
	</cfoutput>
</cfsavecontent>
	...
	<cfoutput>
		<cfif not request.slatwallScope.getCurrentProduct().isNew()>
			<cfif local.permissionService.secureDisplay('admin:entity.detailproduct')>
				<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.detailproduct&productID=#request.slatwallScope.getCurrentProduct().getProductID()#">Product Admin</a></li>
			</cfif>
			<cfif local.permissionService.secureDisplay('admin:entity.detailproducttype')>
				<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.detailproducttype&productTypeID=#request.slatwallScope.getCurrentProduct().getProductType().getProductTypeID()#">Product Type Admin</a></li>
			</cfif>
			<cfif local.permissionService.secureDisplay('admin:entity.detailbrand') && !isNull(request.slatwallScope.getCurrentProduct().getBrand())>
				<li><a href="#request.slatwallScope.getSlatwallRootURL()#/?slatAction=admin:entity.detailbrand&brandID=#request.slatwallScope.getCurrentProduct().getBrand().getBrandID#">Brand Admin</a></li>
			</cfif>
		</cfif>
	</cfoutput>
</cfsavecontent>
