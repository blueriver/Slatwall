...
<Table tableName="SwEmailTemplate">
	...
	<Records>
		...
		<Record emailTemplateID="61d29dd9f6ca76d9e352caf55500b458" emailTemplateName="Verify Account Email Address" emailTemplateObject="AccountEmailAddress" emailBodyHTML="IMPORTANT NOTE: THE LINK BELOW NEEDS TO BE POINTED TO A PAGE ON YOUR SITE WHERE YOU WANT USERS TO BE SENT WHEN THEY VERIFY THEIR EMAIL AND THIS TEXT NEEDS TO BE REMOVED<br /><br />Thank you for creating an account, in order to complete the processes we need you to verify your email by clicking on the following link: http://www.mySlatwallSite.com/?slatAction=public:account.verifyAccountEmailAddress&accountEmailAddressID=${accountEmailAddressID}&verificationCode=${verificationCode}" />
		<Record emailTemplateID="645fce4ea1c24a3a9dce5ca66c7c9ff6" emailTemplateName="Verify Account Primary Email Address" emailTemplateObject="Account" emailBodyHTML="IMPORTANT NOTE: THE LINK BELOW NEEDS TO BE POINTED TO A PAGE ON YOUR SITE WHERE YOU WANT USERS TO BE SENT WHEN THEY VERIFY THEIR EMAIL AND THIS TEXT NEEDS TO BE REMOVED<br /><br />Thank you for creating an account, in order to complete the processes we need you to verify your email by clicking on the following link: http://www.mySlatwallSite.com/?slatAction=public:account.verifyAccountEmailAddress&accountEmailAddressID=${primaryEmailAddress.accountEmailAddressID}&verificationCode=${primaryEmailAddress.verificationCode}" />
