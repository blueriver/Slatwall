...
component displayname="Base Entity" accessors="true" extends="Slatwall.com.utility.BaseObject" {
	...
	// Removed because this is no longer used	
	...
	// Removed in favor of using this in the utilityService
	...
	// Removed in favor of the new populate method in the base object
	...
	// Removed in favor of using the populate method
