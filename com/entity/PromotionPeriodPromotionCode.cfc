...
*/
component displayname="Promotion Period Promotion Code" entityname="SlatwallPromotionPeriodPromotionCode" table="SlatwallPromotionPeriodPromotionCode" persistent="true" extends="BaseEntity" {
	
	// Persistent Properties
	property name="promotionPeriodPromotionCodeID" ormtype="string" length="32" fieldtype="id" generator="uuid" unsavedvalue="" default="";
