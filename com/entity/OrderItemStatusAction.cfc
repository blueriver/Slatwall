...
*/
component displayname="Order Item Status Action" entityname="SlatwallOrderItemStatusAction" table="SlatwallOrderItemStatusAction" persistent="true" output="false" accessors="true" discriminatorcolumn="orderItemStatusActionType" {
