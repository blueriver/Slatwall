								...
								<cfelse>
									<cfif structCount(thisSetting.settingDetails.settingRelationships) eq 1>
										<cfif structKeyList(thisSetting.settingDetails.settingRelationships) eq "productTypeID">
											...
											<cf_SlatwallActionCaller action="admin:entity.detailProductType" text="#local.productType.getSimpleRepresentation()#" queryString="productTypeID=#thisSetting.settingDetails.settingRelationships.productTypeID#">
										</cfif>
									</cfif>
								</cfif>
							<cfelse>
					...
					<td class="admin admin1">
						<cfif thisSetting.settingDetails.settingInherited>
							<cfif isObject(thisSetting.settingObject)>
								<cf_SlatwallActionCaller action="admin:entity.editsetting" queryString="settingID=&returnAction=#request.context.slatAction#&settingName=#thisSetting.settingName#&#thisSetting.settingObject.getPrimaryIDPropertyName()#=#thisSetting.settingObject.getPrimaryIDValue()#" class="btn btn-mini" icon="pencil" iconOnly="true" modal="true" />
							<cfelse>
								<cf_SlatwallActionCaller action="admin:entity.editsetting" queryString="settingID=&returnAction=#request.context.slatAction#&settingName=#thisSetting.settingName#" class="btn btn-mini" icon="pencil" iconOnly="true" modal="true" />
							</cfif>
						<cfelse>
							<cfif isObject(thisSetting.settingObject)>
								<cf_SlatwallActionCaller action="admin:entity.editsetting" queryString="settingID=#thisSetting.settingDetails.settingID#&returnAction=#request.context.slatAction#&settingName=#thisSetting.settingName#&#thisSetting.settingObject.getPrimaryIDPropertyName()#=#thisSetting.settingObject.getPrimaryIDValue()#" class="btn btn-mini" icon="pencil" iconOnly="true" modal="true" />
							<cfelse>
								<cf_SlatwallActionCaller action="admin:entity.editsetting" queryString="settingID=#thisSetting.settingDetails.settingID#&returnAction=#request.context.slatAction#&settingName=#thisSetting.settingName#" class="btn btn-mini" icon="pencil" iconOnly="true" modal="true" />
							</cfif>
						</cfif>
					</td>
				</tr>
