...
<div class="svoadmincommentcreate">
	<form name="addComment" method="post" />
		<input type="hidden" name="slatAction" value="admin:comment.create" />
		
		<cfif structKeyExists(rc, "brand") and isObject(rc.brand)>
			<input type="hidden" name="brandID" value="#rc.brand.getBrandID()#" />
			<input type="hidden" name="returnURL" value="#buildURL(action='admin:brand.edit', queryString="brandID=#rc.brand.getBrandID()#")#" />
		</cfif>
		
		<cfif structKeyExists(rc, "product") and isObject(rc.product)>
			<input type="hidden" name="productID" value="#rc.product.getProductID()#" />
			<input type="hidden" name="returnURL" value="#buildURL(action='admin:product.edit', queryString="productID=#rc.product.getProductID()#")#" />
		</cfif>
