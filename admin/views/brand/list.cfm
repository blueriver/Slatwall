			...
			<tr>
				...
				<td class="administration">
					<ul class="three">
						...
						<cf_SlatwallActionCaller action="admin:brand.delete" querystring="brandID=#local.brand.getBrandID()#" class="delete" type="list" disabled="#local.brand.isDeletable()#" disabledText="#rc.$.Slatwall.rbKey('entity.brand.delete_validateisassigned')#" confirmrequired="true">
					</ul>     						
				</td>
			</tr>
		</cfloop>
