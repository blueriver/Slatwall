...
<cfoutput>
	<div class="svobrandedit">
		<form name="BrandEdit" action="#buildURL('admin:brand.save')#" method="post">
			...
			<dl class="oneColumn">
				<cf_SlatwallPropertyDisplay object="#rc.Brand#" property="BrandName" edit="true" first="true">
				<cf_SlatwallPropertyDisplay object="#rc.Brand#" property="BrandWebsite" edit="true">
			</dl>
