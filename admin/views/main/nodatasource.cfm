<html>
	...
	<body>
		<p>
			...
			<br />
			Option 2) Add/Edit File: <pre>/config/custom/configApplication.cfm</pre> and add a line of code to define a custom datasource such as: <pre>&lt;cfset this.datasource.name = "MyDatasourceName" /&gt;</pre>
		</p>
	</body>
</html>
