...
<cf_SlatwallListingDisplay smartList="#rc.contentSmartList#" recordEditAction="admin:setting.editcontent" recordEditQueryString="returnAction=admin:setting.listcontent"  recordEditModal="true">
