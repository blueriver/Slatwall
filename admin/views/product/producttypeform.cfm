...
<input type="hidden" id="productTypeID" name="productTypeID" value="#rc.productType.getProductTypeID()#" />
    <dl class="oneColumn">
        <dt class="first">
            <label for="productType">#rc.rbFactory.getKeyValue(session.rb,"product.producttype.producttypename")#</label>
		</dt>
		<dd>
		  <input type="text" id="productType" name="productType" value="#rc.productType.getProductType()#" />
		</dd>
		<dt>
            <label for="parentProductType">#rc.rbFactory.getKeyValue(session.rb,"product.producttype.parentproducttype")#</label>
        </dt>
		<dd>
        ...
        <cfloop query="local.pt">
		    <cfif not listFind(local.pt.path,rc.productType.getProductTypeID())><!--- can't be child of itself or any of its children --->
