...
<cfif rc.edit>
	...
	<div id="updatePriceGroupSKUSettingsDialog" class="ui-helper-hidden" title="#rc.$.Slatwall.rbKey('admin.product.pricegroupskuupdatedialog.title')#">
		<form id="updatePriceGroupSKUSettingsForm" action="#buildURL('admin:product.updatePriceGroupSKUSettings')#" method="post">
			...
			<cfloop from="1" to="#arrayLen(rc.priceGroupSmartList.getPageRecords())#" index="local.i">
				...
				<div id="updatePriceGroupSKUSettings_PriceGroupRateInputs[#local.thisPriceGroup.getPriceGroupId()#]" class="ui-helper-hidden">
					...
					<p><input type="radio" name="updatePriceGroupSKUSettings_PriceGroupId[#local.thisPriceGroup.getPriceGroupId()#]_PriceGroupId" value="new amount"> #rc.$.Slatwall.rbKey('admin.product.pricegroupskuupdatedialog.newamount')#: <input type="text" name="updatePriceGroupSKUSettings_PriceGroupId[#local.thisPriceGroup.getPriceGroupId()#]_NewAmount"></p>
				</div>
			</cfloop>
		</form>
	</div>
