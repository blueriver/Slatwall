...
<cfoutput>
	...
	<cf_SlatwallListingDisplay smartList="#rc.product.getProductImagesSmartList()#" 
		...
		<cf_SlatwallActionCaller action="admin:product.createproductimage" class="btn btn-inverse" icon="plus icon-white" icon="plus icon-white" queryString="productID=#rc.product.getProductID()#" modal=true />
</cfoutput>
