...
<cfoutput>
	<table class="listing-grid stripe" id="productTypeSettings">
		...
		<tr>
			...
			<td>
				<input type="radio" name="inheritQuantityHeldBack" value="1" class="checkClear" data-checkClear=".quantityheldbackfield" <cfif not local.definedHere>checked="checked"</cfif>>#rc.$.Slatwall.rbKey('setting.inherit')# ( #rc.Product.getInheritedSetting("quantityHeldBack")# )<br /> 
				<input type="radio" name="inheritQuantityHeldBack" value="0" <cfif local.definedHere>checked="checked"</cfif>><cf_SlatwallPropertyDisplay object="#rc.Product#" property="quantityHeldBack" edit="#rc.edit#" displayType="plain" fieldType="text">
			</td>
			<td>
				<cfif local.thisSettingSource.type eq "Global">
					<a href="#buildURL(action='admin:setting.detail')#">#rc.$.Slatwall.rbKey('entity.setting.global')#</a>
		...
		<tr>
			...
			<td>
				<input type="radio" name="inheritQuantityMinimum" value="1" class="checkClear" data-checkClear=".quantityminimumfield" <cfif not local.definedHere>checked="checked"</cfif>>#rc.$.Slatwall.rbKey('setting.inherit')# ( #rc.Product.getInheritedSetting("quantityMinimum")# )<br /> 
				<input type="radio" name="inheritQuantityMinimum" value="0" <cfif local.definedHere>checked="checked"</cfif>><cf_SlatwallPropertyDisplay object="#rc.Product#" property="quantityMinimum" edit="#rc.edit#" displayType="plain" fieldType="text">
			</td>
			<td>
				<cfif local.thisSettingSource.type eq "Global">
					<a href="#buildURL(action='admin:setting.detail')#">#rc.$.Slatwall.rbKey('entity.setting.global')#</a>
		...
		<tr>
			...
			<td>
				<input type="radio" name="inheritQuantityMaximum" value="1" class="checkClear" data-checkClear=".quantitymaximumfield" <cfif not local.definedHere>checked="checked"</cfif>>#rc.$.Slatwall.rbKey('setting.inherit')# ( #rc.Product.getInheritedSetting("quantityMaximum")# )<br /> 
				<input type="radio" name="inheritQuantityMaximum" value="0" <cfif local.definedHere>checked="checked"</cfif>><cf_SlatwallPropertyDisplay object="#rc.Product#" property="quantityMaximum" edit="#rc.edit#" displayType="plain" fieldType="text">
			</td>
			<td>
				<cfif local.thisSettingSource.type eq "Global">
					<a href="#buildURL(action='admin:setting.detail')#">#rc.$.Slatwall.rbKey('entity.setting.global')#</a>
		...
		<tr>
			...
			<td>
				<input type="radio" name="inheritQuantityOrderMinimum" value="1" class="checkClear" data-checkClear=".quantityorderminimumfield" <cfif not local.definedHere>checked="checked"</cfif>>#rc.$.Slatwall.rbKey('setting.inherit')# ( #rc.Product.getInheritedSetting("quantityOrderMinimum")# )<br /> 
				<input type="radio" name="inheritQuantityOrderMinimum" value="0" <cfif local.definedHere>checked="checked"</cfif>><cf_SlatwallPropertyDisplay object="#rc.Product#" property="quantityOrderMinimum" edit="#rc.edit#" displayType="plain" fieldType="text">
			</td>
			<td>
				<cfif local.thisSettingSource.type eq "Global">
					<a href="#buildURL(action='admin:setting.detail')#">#rc.$.Slatwall.rbKey('entity.setting.global')#</a>
		...
		<tr>
			...
			<td>
				<input type="radio" name="inheritQuantityOrderMaximum" value="1" class="checkClear" data-checkClear=".quantityordermaximumfield" <cfif not local.definedHere>checked="checked"</cfif>>#rc.$.Slatwall.rbKey('setting.inherit')# ( #rc.Product.getInheritedSetting("quantityOrderMaximum")# )<br /> 
				<input type="radio" name="inheritQuantityOrderMaximum" value="0" <cfif local.definedHere>checked="checked"</cfif>><cf_SlatwallPropertyDisplay object="#rc.Product#" property="quantityOrderMaximum" edit="#rc.edit#" displayType="plain" fieldType="text">
			</td>
			<td>
				<cfif local.thisSettingSource.type eq "Global">
					<a href="#buildURL(action='admin:setting.detail')#">#rc.$.Slatwall.rbKey('entity.setting.global')#</a>
		...
		<tr>
			...
			<td>
				<input type="radio" name="inheritShippingWeight" value="1" class="checkClear" data-checkClear=".shippingweightfield" <cfif not local.definedHere>checked="checked"</cfif>>#rc.$.Slatwall.rbKey('setting.inherit')# ( #rc.Product.getInheritedSetting("shippingWeight")# )<br /> 
				<input type="radio" name="inheritShippingWeight" value="0" <cfif local.definedHere>checked="checked"</cfif>><cf_SlatwallPropertyDisplay object="#rc.Product#" property="shippingWeight" edit="#rc.edit#" displayType="plain" fieldType="text">
			</td>
			<td>
				<cfif local.thisSettingSource.type eq "Global">
					<a href="#buildURL(action='admin:setting.detail')#">#rc.$.Slatwall.rbKey('entity.setting.global')#</a>
