...
<div id="modalForm">
<cfoutput>
	<form class="modal" method="post" enctype="multipart/form-data" action="#buildURL('admin:crud.uploadSkuImage')#">
		...
		<div id="actionButtons" class="clearfix">
			...
			<!---<button id="adminproductuploadSkuImage" title="Upload Image" value="admin:crud.uploadSkuImage" name="slatAction" type="submit" disabled="true">#rc.$.Slatwall.rbKey("admin.product.uploadSkuImage")#</button>--->
		</div>
	</form>
</cfoutput>
</div>