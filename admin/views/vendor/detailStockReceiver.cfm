...
<cf_SlatwallDetailForm object="#rc.stockReceiver#">

	<cf_slatwalllistingdisplay smartlist="#rc.$.slatwall.getService('VendorOrderService').getStockReceiverItemSmartList(rc.stockReceiver)#">
