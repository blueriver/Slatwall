...
<cfoutput>
	...
	<cf_HibachiActionCaller action="admin:entity.createloyaltyredemption" class="btn" icon="plus" queryString="loyaltyID=#rc.loyalty.getLoyaltyID()#&redirectAction=admin:entity.editloyaltyRedemption" modal="true"  />
