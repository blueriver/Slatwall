...
<cfoutput>
	...
	<cf_HibachiActionCaller action="admin:entity.createloyaltyaccruement" class="btn" icon="plus" queryString="redirectAction=admin:entity.detailloyalty&loyaltyID=#rc.promotion.getLoyaltyID()#" modal="true"  />
</cfoutput>