...
<cfoutput>
	...
	<cf_SlatwallActionCaller action="admin:entity.createrenewalsubscriptionusagebenefits" class="btn btn-inverse" icon="plus icon-white" queryString="SubscriptionUsageID=#rc.subscriptionUsage.getSubscriptionUsageID()#" />
</cfoutput>