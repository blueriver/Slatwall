...
<cfoutput>
	...
	<cf_HibachiActionCaller action="admin:entity.createloyaltyprogramredemption" class="btn" icon="plus" queryString="loyaltyProgramID=#rc.loyaltyProgram.getLoyaltyProgramID()#" modal="true"  />
