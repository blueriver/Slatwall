...
<form id="newOptionForm" enctype="multipart/form-data" action="#buildURL('admin:option.save')#" method="post">
    ...
    <dl class="oneColumn">
		...
		<cf_SlatwallPropertyDisplay object="#rc.newOption#" property="optionDescription" edit="true" editType="wysiwyg" toggle="show">
    </dl>
	...
	<li optionID="#local.thisOption.getOptionID()#">
		...
		<form name="editFrm#local.i#" enctype="multipart/form-data" action="#buildURL('admin:option.save')#" method="post">
		    ...
		    <dl class="oneColumn">
				...
				<cf_SlatwallPropertyDisplay id="optiondescription#local.i#" object="#local.thisOption#" property="optionDescription" edit="true" editType="wysiwyg" toggle="show">
		    </dl>
