...
<cfoutput>
	<div class="svofrontendorderpayment">
		...
		<cfif $.slatwall.cart().hasValidAccount() and $.slatwall.cart().hasValidOrderShipping() and (rc.edit eq "" || rc.edit eq "account")>
			<div id="checkoutPaymentContent" class="contentBlock">
				...
				<form name="orderPayment" method="post" action="?slatAction=frontend:checkout.saveOrderPayment">
