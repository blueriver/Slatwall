...
component extends="Slatwall.meta.tests.mxunit.SlatwallTestBase" {
	...
	public void function passing_a_number_in_rc_with_e_start_should_set_entityStart() {
		var smartList = new Slatwall.com.utility.SmartList(entityName="SlatwallProduct", rc={e_start=7});
		var expected = 7;
	...
	public void function passing_a_number_in_rc_with_e_show_should_set_entityShow() {
		var smartList = new Slatwall.com.utility.SmartList(entityName="SlatwallProduct", rc={e_show=12});
		var expected = 12;
	...
	public void function the_start_entity_must_be_numeric_otherwise_the_default_of_1_will_be_used() {
		var smartList = new Slatwall.com.utility.SmartList(entityName="SlatwallProduct", rc={e_start="A"});
		var expected = 1;
		var actual = smartList.getEntityStart();
		assertEquals(expected, actual);
	}
	...
	public void function the_end_entity_cant_be_larger_than_the_records_array() {
		var smartList = new Slatwall.com.utility.SmartList(entityName="SlatwallProduct", rc={e_show="A"});
		var expected = 1;
		var actual = smartList.getEntityStart();
		assertEquals(expected, actual);
	}
